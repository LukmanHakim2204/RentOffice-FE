...
export default function BookOffice() {
  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        ...
        const generatedUniqueCode = Math.floor(Math.random() * 900);
      ...
      .catch((error: unknown) => {
        if (axios.isAxiosError(error)) {
          console.error("error loading fetch data", error.message);
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Vadation form data");
    ...
    console.log("Validatio is Valid. Submitting...", formData);
    setIsLoading(true);
    ...
    try {
      ...
      console.log("Form Submit Successfully", response.data.data);
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center rounded-full border border-[#000929] px-5 gap-[10px] transition-all duration-300 focus-within:ring-2 focus-within:ring-[#0D903A]">
                ...
                ) && <p className="text-red-500">Phone Number Required</p>}
              </div>
            </div>
            <div className="flex flex-col gap-2">
